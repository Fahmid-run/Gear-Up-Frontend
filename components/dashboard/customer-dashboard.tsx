...
import { CustomerOverviewSection } from "./dashboard/customer-overview-section";
import { RentalsList } from "./dashboard/rentals-list";
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold text-slate-900">My Rentals</h1>
